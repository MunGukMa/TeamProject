				...
				<c:if test="${sessionScope.fitc_id == null }">
					<form id="login" action="logIN" method="post">
						<table style="border: 1px solid #ccc; width: 140%">
							<tr>
								<td width="250px"><input type="text" name="fitc_id"
									id="fitc_id" placeholder="ID" style="width: 90%" /></td>
							</tr>
							<tr>
								<td width="250px"><input type="password" name="fitc_pw"
		...
		<div class="box1" id="chart_div">
			...
			<div id="nondiv" style="display: none;">
				<table style="width: 100%;">
					<tr>
						<th colspan="2"><img id="gameimg" /></th>
					</tr>
					<tr>
						<th id="spectype" colspan="2"></th>
					</tr>
					<tr>
						<th>운영체제</th>
						<td id="windowtype"></td>
					...
					<tr>
						<td colspan="2"><input id="rebtn" type="button" value="추천견적"
							onclick="fitRecommend()"> <input id="fitbtn"
							type="button" value="맞춤견적" onclick="fitEstimate()"> <input
							id="rvbtn" type="button" value="최저가견적" onclick="alert('최저가견적');">
							<input id="rvbtn" type="button" value="창 닫기"
							onclick="closediv();"></td>
					</tr>
				</table>
