					...
					<div>
						<table class="table" 
							...
							<tr>
								...
								<td><textarea style="width: 100%; resize: none;" rows="10" cols="10"
						...
						<div style="text-align: center">
							<input type="button" value="등록" onclick="boardUpdate()" /> 
							<a href='/one/board/boardRead?fit_boardnum=${board.fit_boardnum}'>취소</a>
						</div>
					</div>
				</div>
			</form>
